...
from employee import Employee  # Import Employee class for relationships
...
class Department:
    ...
    def save(self):
        """Insert or update the Department instance in the database."""
        if self.id is None:
            sql = """
    ...
    def employees(self):
        """Get the employees for the current Department instance."""
